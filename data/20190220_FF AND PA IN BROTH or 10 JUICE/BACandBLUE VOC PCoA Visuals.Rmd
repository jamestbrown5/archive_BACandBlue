...
abund <- read.csv("/Users/jbrown/Documents/GitHub/BACandBlue/data/20190220_FF AND PA IN BROTH or 10 JUICE/otu.csv", colClasses = c("factor","factor", rep("numeric", times= 23)))
...
names(new.dat)[49:51] <- c("microbe","treat","hour")
library(gdata)
