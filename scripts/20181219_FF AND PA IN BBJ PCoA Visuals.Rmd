---
title: "FF AND PA PCoA visuals [StatQuest]"
author: "Brown, J.T."
...
library(ape)
```
###Frigoribacterium faeni (Repellant) & Pantoe aggiomerans (Attractant)
```{r}
...
data.matrix$PEAKID=as.numeric(data.matrix$PEAKID)
...
pca <- prcomp(t(data.matrix), center=TRUE) 
