...
abund <- read.csv("~/GitHub/BACandBlue/data/BACandBLUE_GCdata_FFaeni_10BB_BLANK_PRO_REP/otu5.csv", colClasses = c("factor","factor", rep("numeric", times= 21)))# read in peak areas, assigning factors of diff classifications based on columns
