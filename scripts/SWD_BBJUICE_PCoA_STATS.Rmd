...
## Packages and libraries necessary to complete data analysis.
...
### Group 1 Dataset includes all of the samples from the VOC collections and associated PCoA plots
```{r}
...
abund <- read.csv("/Users/jbrown/Documents/GitHub/BACandBlue/data/BACandSTRAW_SUBSET_SWDvsSBERRY_BLANK_PRO_REP/otu1.csv", colClasses = c("factor","factor", rep("numeric", times= 6)))
