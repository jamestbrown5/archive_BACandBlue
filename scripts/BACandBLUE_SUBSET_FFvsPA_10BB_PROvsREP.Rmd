...
sample_data(VOC)$fpeaks <- factor(sample_data(VOC)$peaks)

str(sample_data(VOC))

fit <- lm(sample_sums(VOC)~sample_data(VOC)$fhour+sample_data(VOC)$spme)
summary(fit)
# same results

fit <- lm(sample_sums(VOC)~ sample_data(VOC)$fhour*sample_data(VOC)$fmicrobe)
anova(fit)
fit <- lm(sample_sums(VOC)~ sample_data(VOC)$rep*sample_data(VOC)$hour*sample_data(VOC)$microbe)
anova(fit)
...
fit <- lm(sample_sums(VOC)~ sample_data(VOC)$rep*sample_data(VOC)$fhour*sample_data(VOC)$microbe)
summary(fit)
######################################################################################################################################
